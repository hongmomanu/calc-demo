...
import { sat_water_asm_x, sat_water_asm_y, sat_water_isentpic_x, sat_water_isentpic_y, sat_water_isent_x, sat_water_isent_y } from "./data";
...
export default function SatWater() {
    ...
    useEffect(() => {
        debCalcApi({calcFormData:{...calcFormData,...{sp_old_unit,ssf_old_unit}},setCalcFormData})
    },[
    ...
    return (
        <Grid container>
            ...
            <Grid item xs={8}>
            <Charts xData={[sat_water_asm_x,sat_water_isent_x,sat_water_isentpic_x]}
      xTickCount={7}
      yTickCount={12}
      yDomain={[0,60000]}
      ...
      scatters={['fc']}
          ...
          yDatas={[
            sat_water_asm_y,
            sat_water_isent_y,
            sat_water_isentpic_y
      ]} columns={['ASME Section VIII','Isentropic',"Isenthalpic"]} />
            </Grid>
