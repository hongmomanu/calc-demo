...
function MultipleApi(){
    const [calcFormData,setCalcFormData] = useState({
      ...
      useEffect(()=>{
        console.log("121212",calcFormData.d,calcFormData.r,calcFormData.re,calcFormData.new_unit)
        TableApiDeb({setCalcFormData,calcFormData,old_unit,url:'/api/line/special/k_Segments'})
...
function CoilsTable() {
    ...
    const [calcFormData,setCalcFormData] = useState({
      ...
      const old_unit = usePrevious(calcFormData.new_unit)
      useEffect(()=>{
        TableApiDeb({setCalcFormData,calcFormData,old_unit,url:'/api/line/special/ld_bend'})
...
function DiaphragmTable(){
    const [calcFormData,setCalcFormData] = useState({
      ...
      const old_unit = usePrevious(calcFormData.new_unit)
      useEffect(()=>{
        TableApiDeb({setCalcFormData,calcFormData,old_unit,url:'/api/line/special/k_diaphragm'})
...
function ElbowTable() {
    ...
    const [calcFormData,setCalcFormData] = useState({
      ...
      const old_unit = usePrevious(calcFormData.new_unit)
      useEffect(()=>{
        TableApiDeb({setCalcFormData,calcFormData,old_unit,url:'/api/line/special/k_elbow'})
...
function ConeTable() {
  ...
  const old_unit = usePrevious(calcFormData.new_unit)
  useEffect(()=>{
    TableApiDeb({setCalcFormData,calcFormData,old_unit,url:'/api/line/special/k_cone'})
  ...
  return (
    <>
      ...
      <Grid container>
        <Grid item xs={4}>
          <div className="fl f-a-c f-j-c h-30 b-1-gray">Inlet section (A1)</div>
        </Grid>
        <Grid item xs={4}>
          <div className="fl f-a-c f-j-c h-30 b-1-gray">
          m2
