...
export default function RdGasLiq() {
  ...
  const urp_old_unit = usePrevious(calcFormData.urp_new_unit)||calcFormData.urp_new_unit;
  const id_old_unit = usePrevious(calcFormData.id_new_unit)||calcFormData.id_new_unit;
  const d_old_unit = usePrevious(calcFormData.d_new_unit)||calcFormData.d_new_unit;
  const l_old_unit = usePrevious(calcFormData.l_new_unit)||calcFormData.l_new_unit;
        ...
        <Grid container>
          <Grid item xs={12}>
            <div className="fl f-a-c h-30">
              Rupture disk checking for high vapour pressure or gassy systems
            </div>
          </Grid>
          <Grid item xs={6}>
